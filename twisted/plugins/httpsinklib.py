...
"""
Support for creating a service which runs a ake server.
"""
...
class Options(usage.Options):
    ...
    optParameters = [["port", "p", None, "strports description of the port to "
                     ...
                     ["privkey", "k", "server.pem", "SSL key to use for HTTPS."],
                     ["sslmethod", "s", "sslv23", "SSL Method. Acceptable: sslv2, sslv3, sslv23, tlsv1, tlsv1_1, tlsv1_2"]
                     ]
